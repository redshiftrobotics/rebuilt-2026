...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        leds = robotType == RobotType.SIM_BOT
    ...
    private void configureOperatorControllerBindings(CommandXboxController xbox) {
        ...
        xbox.leftTrigger().and(xbox.pov(0))
                .onTrue(IntakeCommands.incrementDownSlapdown(intake, IntakeConstants.SLAPDOWN_INCREMENT_SETPOINT));
        xbox.leftTrigger().and(xbox.pov(0))
                .onTrue(IntakeCommands.incrementDownSlapdown(intake, IntakeConstants.SLAPDOWN_INCREMENT_SETPOINT));
