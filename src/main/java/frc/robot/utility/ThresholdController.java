...
public class ThresholdController {
     ...
     */
    public ThresholdController(double activationThreshold, double disableThreshold, Direction direction) {
     ...
     */
    public void setThresholds(double activationThreshold, double disableThreshold, Direction direction) {
