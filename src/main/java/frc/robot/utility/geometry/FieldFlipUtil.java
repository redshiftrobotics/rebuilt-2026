...
public class FieldFlipUtil {
    ...
    public static Translation3d apply(Translation3d translation) {
        ...
        return shouldFlip() ? new Translation3d(flipped2d.getX(), flipped2d.getY(), translation.getZ()) : translation;
    }

    public static Rotation3d apply(Rotation3d rotation) {
        Rotation2d flipped2d = apply(rotation.toRotation2d());
        return shouldFlip() ? new Rotation3d(rotation.getX(), rotation.getY(), flipped2d.getRadians()) : rotation;
    }
