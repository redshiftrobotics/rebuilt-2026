...
// See Mechanical Advantage openalliance build thread post for more details:
// https://www.chiefdelphi.com/t/frc-6328-mechanical-advantage-2026-build-thread/509595/192?u=michael888
...
public class FieldConstants {
    ...
    public static final AprilTagFieldLayout emptyFieldLayout =
            new AprilTagFieldLayout(List.of(), apriltagLayout.getFieldLength(), apriltagLayout.getFieldWidth());
    ...
    public static class Hub {
        ...
        public static final Translation3d topCenterPoint =
                new Translation3d(apriltagLayout.getTagPose(26).get().getX() + width / 2.0, fieldWidth / 2.0, height);
        public static final Translation3d innerCenterPoint = new Translation3d(
                apriltagLayout.getTagPose(26).get().getX() + width / 2.0, fieldWidth / 2.0, innerHeight);

        public static final Translation2d center = topCenterPoint.toTranslation2d();
        ...
        public static final Translation3d oppTopCenterPoint =
                new Translation3d(apriltagLayout.getTagPose(4).get().getX() + width / 2.0, fieldWidth / 2.0, height);
    ...
    public static class Tower {
        ...
        public static final Translation2d leftUpright = new Translation2d(
                frontFaceX,
                (apriltagLayout.getTagPose(31).get().getY()) + innerOpeningWidth / 2 + Units.inchesToMeters(0.75));
        ...
        public static final Translation2d oppCenterPoint = new Translation2d(
                fieldLength - frontFaceX, apriltagLayout.getTagPose(15).get().getY());
        public static final Translation2d oppLeftUpright = new Translation2d(
                fieldLength - frontFaceX,
                (apriltagLayout.getTagPose(15).get().getY()) + innerOpeningWidth / 2 + Units.inchesToMeters(0.75));
