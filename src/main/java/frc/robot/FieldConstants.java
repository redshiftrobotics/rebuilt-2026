...
public class FieldConstants {
  ...
  public static final AprilTagFieldLayout emptyFieldLayout =
      new AprilTagFieldLayout(
          List.of(), apriltagLayout.getFieldLength(), apriltagLayout.getFieldWidth());
  ...
  public static class Hub {
    ...
    new Translation3d(
      ...
      new Translation3d(
        ...
        public static final Translation2d center = new Translation2d(Hub.topCenterPoint.getX(), Hub.topCenterPoint.getY());
