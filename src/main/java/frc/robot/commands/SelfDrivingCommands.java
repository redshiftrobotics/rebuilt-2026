...
public class SelfDrivingCommands {
    static PathConstraints constraints = new PathConstraints(
            DRIVE_CONFIG.maxLinearVelocity(), 4.0, Units.degreesToRadians(540), Units.degreesToRadians(720));
    ...
    private static boolean isInNeutralZone(Pose2d pose) {
        return MathUtil.isNear(FieldConstants.LinesVertical.center, pose.getX(), Units.inchesToMeters(120));
    }
