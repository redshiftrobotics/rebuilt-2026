...
public class LaunchCommands {
    ...
    public static Command driveWhileLaunching(
            Drive drive, AprilTagVision vision, final Supplier<ChassisSpeeds> initialRobotRelativeSpeedsSupplier) {
        return drive.run(() -> {
                    ...
                    if (!parameters.passing()) {
                        ...
                        double hubAngle = driveLaunchMaxPolarVelocityRadPerSec.get()
                        ...
                        if (initialLinearVelocity.getNorm() > maxLinearVelocityMagnitude) {
                            initialLinearVelocity = initialLinearVelocity.times(
                ...
                .beforeStarting(vision::enableForwardCameraMode)
                .finallyDo(vision::disableForwardCameraMode);
    }
