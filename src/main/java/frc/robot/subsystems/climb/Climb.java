...
/** 
 * The subsystem that controls the climber mechanism on the robot.
 * Adapted from: {@link https://github.com/redshiftrobotics/crescendo-2024/tree/main/src/main/java/frc/robot/subsystems/hang}
 * 
 * @author Aceius E.
*/
