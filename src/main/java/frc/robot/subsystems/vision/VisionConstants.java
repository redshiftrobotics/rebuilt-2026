...
public class VisionConstants {
    ...
    public record CameraConfig(String cameraName, CameraPositionName cameraPosition, Transform3d robotToCamera) {}
    ...
    public static final CameraConfig BACK_SWERVE_RIGHT_CAMERA = new CameraConfig(
            "kathycam",
    ...
    public static Transform3d fromOnshape(
        ...
        return new Transform3d(
                new Translation3d(
                        Units.inchesToMeters(-yInches), Units.inchesToMeters(xInches), Units.inchesToMeters(zInches)),
                new Rotation3d(0, Units.degreesToRadians(pitchDegrees), Units.degreesToRadians(yawDegrees)));
    }
}
