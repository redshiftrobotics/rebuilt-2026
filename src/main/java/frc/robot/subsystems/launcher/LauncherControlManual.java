...
public class LauncherControlManual implements Supplier<LauncherState> {
    ...
    private static class AdjustableSetpoint {
        ...
        LauncherState get() {
            return new LauncherState(base.wheelRadPerSec() + velocityShift, base.hoodPosition() + hoodShift);
        }
    ...
    private final EnumMap<ManualLaunchMode, AdjustableSetpoint> setpoints = new EnumMap<>(ManualLaunchMode.class);
