 ...
 */
public class SwerveSetpointGenerator8032 {
   ...
   *     per second
   */
  public SwerveSetpointGenerator8032(RobotConfig config, double maxSteerVelocityRadsPerSec) {
    this.config = config;
   ...
   */
  public SwerveSetpointGenerator8032(RobotConfig config, AngularVelocity maxSteerVelocity) {
