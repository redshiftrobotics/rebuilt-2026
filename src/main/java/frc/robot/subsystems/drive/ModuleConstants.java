...
public class ModuleConstants {
    ...
    public record ModuleConfig(
        ...
        public ModuleConfig(
                SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> config) {
            this(
                    config.DriveMotorId,
                    config.SteerMotorId,
                    config.EncoderId,
    ...
    static {
        switch (Constants.getRobot()) {
            ...
            case METALBOT_2:
                System.err.println(
                        "DO NOT USE THESE CONSTANTS, USE TUNER CONSTANTS DIRECTLY INSTEAD, HERE FOR REFERENCE");
                FRONT_LEFT_MODULE_CONFIG = new ModuleConfig(MetalbotTwoConstants.FrontLeft);
                FRONT_RIGHT_MODULE_CONFIG = new ModuleConfig(MetalbotTwoConstants.FrontRight);
                BACK_LEFT_MODULE_CONFIG = new ModuleConfig(MetalbotTwoConstants.BackLeft);
                BACK_RIGHT_MODULE_CONFIG = new ModuleConfig(MetalbotTwoConstants.BackRight);
                break;
            case PRESEASON_2026:
                System.err.println(
                        "DO NOT USE THESE CONSTANTS, USE TUNER CONSTANTS DIRECTLY INSTEAD, HERE FOR REFERENCE");
                FRONT_LEFT_MODULE_CONFIG = new ModuleConfig(PreseasonConstants.FrontLeft);
                FRONT_RIGHT_MODULE_CONFIG = new ModuleConfig(PreseasonConstants.FrontRight);
                BACK_LEFT_MODULE_CONFIG = new ModuleConfig(PreseasonConstants.BackLeft);
                BACK_RIGHT_MODULE_CONFIG = new ModuleConfig(PreseasonConstants.BackRight);
                break;

            case REEFSCAPE_2025:
                FRONT_LEFT_MODULE_CONFIG =
                        new ModuleConfig(19, 18, 37, Rotation2d.fromRotations(-0.596435546875), true);
                FRONT_RIGHT_MODULE_CONFIG = new ModuleConfig(2, 1, 36, Rotation2d.fromRotations(-0.96826171875), true);
                BACK_LEFT_MODULE_CONFIG = new ModuleConfig(10, 11, 39, Rotation2d.fromRotations(-0.477294921875), true);
                BACK_RIGHT_MODULE_CONFIG = new ModuleConfig(8, 9, 38, Rotation2d.fromRotations(-0.530517578125), true);
                break;
            ...
            case CHASSIS_CANNON:
                ...
                BACK_LEFT_MODULE_CONFIG = new ModuleConfig(11, 10, 36, Rotation2d.fromRotations(-0.8603515625), true);
