...
public class ModuleIOTalonFX implements ModuleIO {
    ...
    public ModuleIOTalonFX(
        ...
        driveConfig.MotorOutput.NeutralMode = driveBrakeMode ? NeutralModeValue.Brake : NeutralModeValue.Coast;
        ...
        turnConfig.MotorOutput.NeutralMode = turnBrakeMode ? NeutralModeValue.Brake : NeutralModeValue.Coast;
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(DriveConstants.ODOMETRY_FREQUENCY_HERTZ, drivePosition, turnPosition);
