...
public class ModuleIOSparkMax implements ModuleIO {
    ...
    public ModuleIOSparkMax(ModuleConfig config) {
        ...
        drivePositionQueue =
                SparkOdometryThread.getInstance().registerSignal(driveSpark, driveRelativeEncoder::getPosition);
        turnPositionQueue =
    ...
    public void setTurnPosition(double angleRads) {
        turnFeedback.setSetpoint(Units.radiansToRotations(angleRads), ControlType.kPosition, ClosedLoopSlot.kSlot0);
    }
