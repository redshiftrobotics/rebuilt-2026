...
public class DrivePoseController {
    ...
    public DrivePoseController(Drive drive) {
        ...
        controller.setTolerance(new Pose2d(TRANSLATION_TOLERANCE, TRANSLATION_TOLERANCE, ROTATION_TOLERANCE));
    ...
    public void reset() {
        ...
        controller
                .getThetaController()
                .reset(drive.getRobotPose().getRotation().getRadians(), drive.getRobotSpeeds().omegaRadiansPerSecond);
    }
