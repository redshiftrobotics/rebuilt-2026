...
public class Hopper extends SubsystemBase {
    ...
    /* Alerts */
    private final Alert feederDisconnectedAlert = new Alert("Feeder motor disconnected, ", AlertType.kError);
    private final Alert lifterMotorDisconnectedAlert = new Alert("Lifter motor disconnected", AlertType.kError);
    ...
    private static final TunablePID lifterPID = lifterGains.pid("Lifter_PID", HopperConstants.LIFTER_FEEDBACK);
    ...
    public Hopper(HopperMotorIO feederIO, HopperMotorIO lifterIO) {
        ...
        setpointVisualizer = new HopperVisualizer(getName() + "/Visualization/Setpoint", Color.kBlue, 0.01);
    ...
    public static Hopper create(RobotType robotType) {
        switch (robotType) {
            ...
            case SIM_BOT:
                return new Hopper(
                        new HopperMotorIOSim(HopperConstants.LIFTER_MOTOR, HopperConstants.FEEDER_CONSTANTS, 0.1),
                        new HopperMotorIOSim(HopperConstants.FEEDER_MOTOR, HopperConstants.LIFTER_CONSTANTS, 0.1));
